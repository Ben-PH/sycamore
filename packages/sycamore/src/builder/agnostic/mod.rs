    ...
    G: GenericNode,
{
    ...
    /// Set the inner html of the element using
    /// [generic_node::GenericNode::dangerously_set_inner_html].
    pub fn inner_html<'a>(&self, html: impl AsRef<str> + 'a) -> &Self {
        self.element.dangerously_set_inner_html(html.as_ref());
        &self
    }
